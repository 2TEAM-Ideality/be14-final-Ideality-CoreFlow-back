...
desc delay_reason;
select * from user;
select * from work where project_id=4;
...
DELETE w1 FROM work w1
                   JOIN work w2
                        ON w1.name = w2.name
                            ...
                            AND w1.start_base = w2.start_base
                            AND w1.end_base = w2.end_base
                            AND w1.project_id = w2.project_id
WHERE w1.id > w2.id;

DELETE FROM work WHERE id >= 28 AND id < 34;